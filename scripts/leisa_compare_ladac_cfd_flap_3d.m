...
cfd_3d = cfdJunaidImportWingAll('TEF2_7deg/wing');
...
figure
[X,Y] = meshgrid(cfd_3d.time(:),eta_interp);
surf(X,Y,c_L_RANS_interp(:,:)','FaceAlpha',0.3)
hold on
surf(X,Y,c_L_VLM_interp(:,eta_interp_idx)','FaceAlpha',0.3,'EdgeColor','r')
grid on
